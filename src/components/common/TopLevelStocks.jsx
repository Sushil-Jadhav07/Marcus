...
/**
 * TopLevelStocks
 * - Fetches OI movers (PercOIGainers NEAR) and displays
 *   trading symbol with OI metrics
 */
const TopLevelStocks = ({
  ...
  const CACHE_KEY = `cache_TopLevelStocks_${title}`;
