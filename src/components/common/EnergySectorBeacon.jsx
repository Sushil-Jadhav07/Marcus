...
const EnergySectorBeacon = () => {
  ...
  // Energy sector symbols - Top 10 only with symbol tokens
  const energySymbols = [
    { exchange: "NSE", tradingSymbol: "RELIANCE", symbolToken: "2881" },
{ exchange: "NSE", tradingSymbol: "ONGC", symbolToken: "11536" },
{ exchange: "NSE", tradingSymbol: "IOC", symbolToken: "4151" },
{ exchange: "NSE", tradingSymbol: "BPCL", symbolToken: "526" },
{ exchange: "NSE", tradingSymbol: "HPCL", symbolToken: "13696" },
{ exchange: "NSE", tradingSymbol: "GAIL", symbolToken: "11599" },
{ exchange: "NSE", tradingSymbol: "PETRONET", symbolToken: "6713" },
{ exchange: "NSE", tradingSymbol: "ADANIGREEN", symbolToken: "25" },
{ exchange: "NSE", tradingSymbol: "ADANIPORTS", symbolToken: "24" },
{ exchange: "NSE", tradingSymbol: "TATAPOWER", symbolToken: "11536" }
  ];
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const res = await fetch(url, {
        ...
        body: JSON.stringify({ symbols: energySymbols }),
      });
      ...
      console.error('Energy sector fetch failed', e);
      setRows([]);
    } finally {
      setIsLoading(false);
    }
