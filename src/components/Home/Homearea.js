...
const Homearea = () => {
  return (
    ...
    <div className='md:hidden flex flex-col justify-start w-[90%] p-10 relative '>
       ...
       <div className='flex flex-col items-center justify-start h-full pt-0 w-full z-10'>
        ...
        <p className='text-white text-xs text-   mt-5'>Lorem ipsum dolor sit amet, consectetur   adipiscing        elit, sed do eiusmod
