        ...
        <div className="grid grid-cols-3 gap-3">
          {learningItems.map((item, index) => (
            <div key={index} className="relative">
              ...
              {/* Main card */}
              <div className="relative backdrop-blur-lg rounded-xl border-t-2 border-r-2 border-b-2 border-l-2 border-t-white/60 border-r-white/60 border-b-blue-400/60 border-l-blue-400/60 p-3 h-24 flex items-end bg-white dark:bg-black">
